...
export class PollService {
  ...
  getPoll(): Question[] {
      ...
      var mock = [{ questionId: 1, pollId: 1, questionType: "text", quesionDetails: { questionText: "Test Question"} },
      { questionId: 2, pollId: 1, questionType: "text", quesionDetails: { questionText: "Second Question"} }];
